...
const COLORS = {
  PRIMARY: '#FF585D',
  PRIMARY_TINT: '#FF696D',
  PRIMARY_SHADE: '#e04d52',
  SECONDARY: '#FFB600',
  SECONDARY_TINT: '#FFBD1A',
  SECONDARY_SHADE: '#E0A000',
  TERTIARY: '#833177',
  TERTIARY_TINT: '#8F4685',
  TERTIARY_SHADE: '#732B69',
  QUATERNARY: '#007672',
  QUATERNARY_TINT: '#1A8480',
  QUATERNARY_SHADE: '#006864',
  BLUE: '#0092D6',
  BLUE_TINT: '#1A9DDA',
  BLUE_SHADE: '#0080BC',
  WHITE: '#FFFFFF',
...
const SIZES = {
  ...
  // Map
  MAP_PIN_SMALL_SIZE: 24,
  MAP_PIN_NORMAL_SIZE: 32,
  MAP_PIN_LARGE_SIZE: 48,
